  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: `Vous êtes connecté en tant que ${role === 'coordinator' ? 'demandeur' : 'technicien'}.`,
      });
          ...
          <div className="space-y-2">
            ...
            >
              <div className="flex items-center space-x-2 border p-3 rounded-md hover:bg-accent cursor-pointer">
                ...
                <Label htmlFor="role-coordinator" className="flex-grow cursor-pointer">Demandeur</Label>
              </div>
              <div className="flex items-center space-x-2 border p-3 rounded-md hover:bg-accent cursor-pointer">
